...
public interface UserRepository extends JpaRepository<User, Long> {
  ...
  @Query("SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.roleList LEFT JOIN FETCH u.organization WHERE u.registerStatus = :registerStatus ORDER BY u.createdDate DESC, u.id DESC")
