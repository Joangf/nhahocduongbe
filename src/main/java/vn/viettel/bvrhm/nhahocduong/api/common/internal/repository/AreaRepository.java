package vn.viettel.bvrhm.nhahocduong.api.common.internal.repository;
...
public interface AreaRepository extends JpaRepository<Area, Integer> {
  ...
  @Query(
    ...
    WHERE
      ...
      AND district.type = 2
  """)
  List<Area> listDistrictsByProvinceCode(@Param("provinceCode") String provinceCode);
  ...
  List<Area> listPrecinctByProvinceCodeAndDistrictCode(
      @Param("provinceCode") String provinceCode, @Param("districtCode") String districtCode);
  ...
  """,
      nativeQuery = true)
  List<String> getChildrenAreaCodeByParentCode(@Param("parentAreaCode") String parentCode);
  ...
  """)
  List<Area> searchAllByCondition(
      @Param("splitProvinceCode") int splitProvinceCode, @Param("region") String regionString);
}
