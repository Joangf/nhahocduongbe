...
VALUES (1, 'Bệnh viện Răng hàm mặt Trung ương', 'BVRHM', 'Thành phố Hồ Chí Minh', '79', null, 4),
        (2, 'Sở Y tế Tỉnh Vĩnh Long', 'VL-SYT', 'Tỉnh Vĩnh Long', '86', null, 3),
        (3, 'Phòng Giáo dục và Đào tạo Huyện Chợ Lách', 'VL-COL-PGD', 'Huyện Chợ Lách, Tỉnh Vĩnh Long', '86', null, 2),
        (4, 'Trường TH Thị trấn Chợ Lách', 'VL-CL-PGD', 'Thị trấn Chợ Lách, Tỉnh Vĩnh Long', '86', null, 1),
        (5, 'Trường TH Thị trấn Giồng Trôm', 'VL-GT-PGD', 'Thị trấn Giồng Trôm, Tỉnh Vĩnh Long', '86', null, 1),
        (6, 'Trường TH Chu Văn An', 'VL-CVA-PGD', 'Xã Phú Phụng, Huyện Chợ Lách, Tỉnh Vĩnh Long', '86', null, 1),
        (7, 'Trường TH Trần Hoàn Vũ', 'VL-THV-PGD', 'Xã Vĩnh Bình, Huyện Chợ Lách, Tỉnh Vĩnh Long', '86', null, 1),
        (8, 'Trường TH Tân Bình', 'VL-TB-PGD', 'Xã Tân Bình, Huyện Chợ Lách, Tỉnh Vĩnh Long', '86', null, 1),
        (9, 'Trường TH Tân Thạch A', 'VL-TA-PGD', 'Xã Tân Thạch, Huyện Chợ Lách, Tỉnh Vĩnh Long', '86', null, 1),
        (10, 'Trường TH An Thới', 'VL-AT-PGD', 'Xã An Thới, Huyện Chợ Lách, Tỉnh Vĩnh Long', '86', null, 1),
        (11, 'Trường TH Thị trấn Thạnh Phú', 'VL-TP-PGD', 'Thị trấn Thạnh Phú, Huyện Chợ Lách, Tỉnh Vĩnh Long', '86', null, 1),
        (12, 'Trường TH An Bình Tây', 'VL-ABT-PGD', 'Xã An Bình Tây, Huyện Chợ Lách, Tỉnh Vĩnh Long', '86', null, 1)
;
...
insert into NHAHOCDUONG_ORGANIZATION (id, name, code, address, area_code, classes, type)
values (10000, 'Trường tiểu học Nguyễn Du', 'VL001', 'Tỉnh Vĩnh Long', '86', null, 1),
...
values (175, 'Nguyễn Văn Sỹ', 'DN5797939589580', 1, '2023-05-28', '0', 'Nông thôn', '09090901234', 'Bắc Ninh', '2A1',
        '061079013187777', 'Nguyễn Văn Thủy', 3),
       (178, 'Nguyễn Tuấn Minh', '1awwr', 2, '2023-05-29', '', 'Thành thị', '09090901234', 'Hà Nội', '1A1', '1234',
        'nghh', 3),
       (119, 'Phan Huy Khang', 'DN5797915126119', 1, '2014-01-01', 'Kinh', 'Thành thị', '0966934212', '', '3A1',
        '064029013138', 'Phan Khang Huy', 1),
       (149, 'Nguyễn Sỹ Hải', 'DN5797935812845', 1, '2014-02-11', 'Kinh', 'Ngoại ô', '0969737185', '', '3A1',
        '061089013182', '', 4),
       (121, 'Đặng Thị Mỹ Dung', 'DN5797911454271', 2, '2014-06-15', 'Kinh', 'Thành thị', '0932790158', null, '3A1',
        '071089013185', null, 1),
       (144, 'Phạm Văn Hải', 'DN5797916279377', 1, '2014-11-30', 'Kinh', 'Ngoại ô', '0345625588', '', '3A1',
        '064029016187', 'nhupkj0', 7),
       (182, 'Đặng Trung Nghĩaa', 'sv1221214353650', 1, '2015-06-01', '0', 'Ngoại ô', '09090901234', 'Tây Ninh', '1A2',
        '0302555554540', 'Đặng Giám Hộ', 5),
       (101, 'Phan Huy Ích', 'DN5797915311385', 1, '2015-01-01', 'Kinh', 'Thành thị', '0375728325',
        '280 Cách Mạng Tháng 8, Phường 12, Quận 10, TP.HCM', '2A1', '064029013182', 'Phan Khang Huy', 1),
       (141, 'Phan Văn Hải', 'DN5797933625648', 1, '2015-01-01', 'Kinh', 'Ngoại ô', '0355155531', '', '2A2',
        '064029013185', 'Phan Khang Huyy', 1),
       (3, 'Lê Danh Pha', 'DN5797936457968', 1, '2015-01-20', 'Kinh', 'Nông thôn', '0367717714', null, '2A1',
        '061029013188', null, 3),
       (159, 'Hồ Văn Hải', 'DN5790205089639', 1, '2015-02-01', 'Kinh', 'Thành thị', '0335945634', '', '2A1',
        '061029011191', '', 3),
       (154, 'Nguyễn Thị Vân', 'DN5797934814868', 2, '2015-06-07', 'Kinh', 'Ngoại ô', '0393189216', 'TP HCM', '2A2',
        '063089013186', 'ae', 3),
       (162, 'Nguyễn Thị Ngọc Ánh', 'DN5790038205689', 2, '2015-06-07', 'Kinh', 'Ngoại ô', '0987614395', '', '2A2',
        '061089013191', 'qwe', 1),
       (110, 'Nguyễn Lê Phan', 'DN5797937465398', 1, '2015-06-16', 'Kinh', 'Ngoại ô', '0357900960', null, '2A3',
        '061059013190', null, 4),
       (126, 'Nguyễn Trần Anh Tú', 'DN5797914443703', 1, '2015-10-30', 'Kinh', 'Nông thôn', '0359414455', null, '2A3',
        '063089013389', null, 5),
       (102, 'Phan Văn Đăng', 'DN5797911017992', 1, '2016-01-01', 'Kinh', 'Ngoại ô', '0865866619', null, '1A2',
        '064029013586', null, 1),
       (131, 'Phan Huy Khang', 'DN5797911178482', 1, '2016-01-01', 'Kinh', 'Thành thị', '0382145484', null, '1A2',
        '064029013160', null, 1),
       (158, 'Nguyễn Sỹ Hải', 'DN5797939470581', 1, '2016-01-01', 'Kinh', 'Ngoại ô', '0979855397', 'TP HCM', '1A2',
        '061089013185', 'Nguyen Van Toan', 1),
       (172, 'Phạm Trường Quân', 'DN5797912359603', 1, '2016-05-30', 'Kinh', 'Ngoại ô', '09090901234', 'Bình Định',
        '1A1', '064029014189', '', 6),
       (167, 'Nguyễn Tuấn Tú', 'DN5797933636011', 1, '2016-06-01', 'Kinh', 'Ngoại ô', '0335042469', 'TP HCM', '1A1',
        '063089023188', '', 1),
       (173, 'Lê Thị Nhã Phương', 'DN5797916132525', 2, '2016-06-01', 'Kinh', 'Thành thị', '0983089241', 'TP HCM',
        '1A1', '061039013184', 'nghh', 1),
       (168, 'Nguyễn Tuấn Hải', 'DN5797916122500', 1, '2016-06-02', 'Kinh', 'Ngoại ô', '0964800230', 'TP HCM', '1A1',
        '063089013191', 'ngh', 1),
       (1, 'Nguyễn Văn Lạc', 'DN5797910626461', 1, '2016-11-11', 'Kinh', 'Nông thôn', '0365720169', null, '1A3',
        '063089043190', null, 1),
       (2, 'Nguyễn Thị Thủy', 'DN5797910926420', 2, '2016-12-11', 'Kinh', 'Ngoại ô', '0399971111', null, '1A2',
        '063089003395', null, 1),
       (169, 'Lê Văn Viễn', 'DN5798022703183', 1, '2016-06-02', 'Kinh', 'Nông thôn', '0327993479', '', '1A1',
        '061039013186', 'nghh', 1),
       (166, 'Nguyễn Tuấn Minh', 'DN5797910126460', 1, '2016-06-08', 'Kinh', 'Nông thôn', '0359733643', '', '1A3',
        '063089023193', '', 5),
       (161, 'Đặng Trần Khánh', 'DN5797910326660', 1, '2016-06-09', 'Kinh', 'Thành thị', '0366044857', '', '1A3', '',
        '', 1),
       (171, 'Hồ Thị Tường Vy', 'DN5797910826460', 2, '2016-06-10', 'Kinh', 'Thành thị', '0938324834', 'TP HCM', '1A1',
        '041089013189', '', 1),
       (157, 'Nguyễn Văn Đăng', 'DN5797910624460', 1, '2016-06-15', 'Kinh', 'Thành thị', '0345996073', 'Hà Nội', '1A1',
        '064024013191', 'addddd', 1),
       (156, 'Phạm Văn Đồng', 'DN5797910426420', 1, '2016-06-16', 'Kinh', 'Ngoại ô', '0978542629', 'Đà Nẵng', '1A2',
        '071089013183', '', 7),
       (163, 'Nguyễn Văn Kha', 'DN5797910525460', 1, '2016-07-08', 'Kinh', 'Ngoại ô', '0968069651', 'TP HCM', '1A3',
        '063089033194', 'Nguyễn Văn Khá', 7),
       (160, 'Nguyễn Văn Sỹ', 'DN5797910632460', 1, '2016-08-08', 'Kinh', 'Thành thị', '0367048333', '', '1A2',
        '063089053192', '', 5),
       (122, 'Nguyễn Trần Anh Thơ', 'DN5797910426460', 1, '2016-11-11', 'Kinh', 'Nông thôn', '0979791765', null, '1A1',
        '063089012187', null, 7),
       (147, 'Lê Công Pha', 'DN5797910826663', 1, '2016-11-11', 'Kinh', 'Nông thôn', '0388941310', null, '1A2',
        '061029013184', null, 1),
       (151, 'Lê Phan', 'DN5797910226663', 1, '2016-11-11', 'Kinh', 'Nông thôn', '0332146609', 'Tuyên Quang', '1A1',
        '061029013189', '213213', 7),
       (155, 'Hoàng Đôn Thiện Hiếu', 'DN5797910326420', 1, '2016-06-16', 'Kinh', 'Thành thị', '09090901234', '', '1A1',
        '041089013187', '', 1),
       (170, 'Lê Quang Tấn', 'DN5797910926421', 1, '2016-11-11', 'Kinh', 'Ngoại ô', '09090901234', 'Tỉnh Vĩnh Long',
        '1A1', '061029013383', 'adad', 4)
;
...
insert into nhahocduong_exam(id, patient_id, dentist_id, organization_id, class, year, teeth_record_id,
                             plaque_record_id, tartar_record_id)
values (1, 1, 2, 1, '1A', '2023', 1, 1, 1)
